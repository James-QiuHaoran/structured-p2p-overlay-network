...
num_countries_in_a_continent=5
num_states_in_a_country=5
num_cities_in_a_state=4
num_districts_in_a_city=5
num_nodes_in_a_district=20
...
do
	...
	num_nodes_in_city=10
	num_cnodes_in_city=2
	num_nodes_in_state=8
	num_cnodes_in_state=2
	num_nodes_in_country=10
	num_cnodes_in_country=2
	num_nodes_in_continent=10
